        ...
        try {
            ...
            for (Column column: table.getColumns()) {
                ...
                if (ac.canChangeColumnData(column)) {
                    ...
                    if (!EditWindowUtils.NOT_SUPPORTED_TYPES.contains(type)) {
                    ...
                    if (!EditWindowUtils.NOT_SUPPORTED_TYPES.contains(type)) {//The AttributeType can be edited by default:
    ...
    private Sheet.Set prepareNodesProperties() {
        try {
            if (multipleNodes) {
                ...
                Property p;
                //Size:
                p = new PropertySupport.Reflection(node, Float.TYPE, "getSize", "setSize");
                p.setDisplayName(NbBundle.getMessage(EditNodes.class, "EditNodes.size.text"));
                p.setName("size");
                set.put(p);
